...
however, in our final dataset, which only indicated the party of the
president, rather than a number.

The final dataset `pols_month` spans from January 1947 to
`pull(pols_month, month)[1]` 1947 to June 2015. It has 822 rows and 9
columns.
